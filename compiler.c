 ...
 * - cause_trigger: A key phrase from the compiler's error message.
 * - cause_info: A human-readable explanation of the error and how to potentially fix it.
 */
typedef struct {
        char *cause_trigger;
        char *cause_info;
 ...
 */
static const char
*find_error_description(const char *line)
{
        int index;
