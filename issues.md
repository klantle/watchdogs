...
| **Virus/Malware** | Why i detected a virus or malware in watchdogs binary. | because watchdogs is use UPX - https://upx.github.io/ for compressing the binary size.. trigger of virus and malware from compressing mode on UPX |